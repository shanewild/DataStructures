...
public class DFSGraph {
    public static class UnweightedGraph<V> extends AbstractGraph<V> {
    ...
    public static class UnweightedGraphWithNonrecursiveDFS<V> extends UnweightedGraph {
        /** Construct a graph from vertices and edges stored in arrays */
        ...
        public Tree dfs(int v) {
            ...
            boolean[] discovered = new boolean[getSize()];
            ...
            while (!stack.isEmpty()) {
                ...
                discovered[v] = true;
                System.out.print(v + " ");
                for (int i = neighbors.indexOf(v)-1; i >= 0; i--) {
                    int u =  getIndex(i);
